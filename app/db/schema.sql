...
CREATE TABLE credit_cards (
  ...
  card_type varchar(20) NOT NULL,   -- e.g. ,visa, Master card
  billing_address_id SERIAL NOT NULL,
  expiration_month int NOT NULL,
  expiration_year int NOT NULL,
  created_at timestamp DEFAULT now(),
  FOREIGN KEY (renter_id) REFERENCES renters_profile(id),
  FOREIGN KEY (billing_address_id) REFERENCES renter_addresses(id) 
);
...
CREATE TABLE agent_assigned (
  ...
  FOREIGN KEY (agent_id) REFERENCES agents_profile(id),
  FOREIGN key (renter_id) REFERENCES renters_profile(id)
);
...
CREATE TABLE bookings (
  ...
  payment_card_id SERIAL NOT NULL,
  price NUMERIC(10, 2) NOT NULL,
  booking_date timestamp DEFAULT now(),
  booking_status varchar(20) DEFAULT 'pending', -- 'pending', 'confirmed', 'cancelled'
  FOREIGN KEY (renter_id) REFERENCES renters_profile(id),
  FOREIGN KEY (payment_card_id) REFERENCES credit_cards(id),
  FOREIGN KEY (property_id) REFERENCES properties(id)
...
INSERT INTO renters_profile (id, move_in_date, preferred_location, budget) VALUES (2, '2025-09-01', 'Chicago, IL', 2500.00);
INSERT INTO agents_profile (id, job_title, agency, contact_info) VALUES (1, 'Real Estate Agent', 'DreamHomes Realty', 'test@dreamhomes.com');
INSERT INTO  renter_addresses (renter_id, street, city, state, zip) VALUES (2, '123 State Street', 'Chicago', 'IL', '60616');
INSERT INTO credit_cards (renter_id, card_number, card_type, billing_address_id, expiration_month, expiration_year) VALUES (2, '15056415105421', 'Visa', 1, 12, 2026);
INSERT INTO agent_assigned (agent_id, renter_id) VALUES (1, 2);
...
INSERT INTO bookings (renter_id, property_id, start_date, end_date, payment_card_id, price, booking_status) VALUES (2, 1, '2025-11-08', '2026-11-08', 1, 2200.00, 'confirmed');

INSERT INTO reward_program (renter_id, total_points) SELECT renter_id, SUM(price) * 100 FROM bookings WHERE renter_id = 2 GROUP BY renter_id;
